    ...
    return (
        <div className="flex flex-col my-8 mx-5 justify-between items-center h-auto">
            <div className="flex flex-col flex-grow justify-evenly items-center ">
                <TextItem title="SOMETHING AWESOME IS COMING SOON" className={"tracking-tight sm:tracking-wide md:tracking-widest text-2xl sm:text-2xl md:text-3xl font-semibold md:font-bold antialiased sm:subpixel-antialiased md:antialiased text-center "}/>
